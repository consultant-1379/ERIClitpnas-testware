...
class Story6817(GenericTest):
    ...
    @attr('all', 'revert', 'story6817', 'story6817_tc01')
    ...
    @attr('all', 'revert', 'story6817', 'story6817_tc02')
    ...
    @attr('all', 'revert', 'story6817', 'story6817_tc03')
    ...
    @attr('all', 'revert', 'story6817', 'story6817_tc04')
    ...
    @attr('all', 'revert', 'story6817', 'story6817_tc06')
    def test_06_n_increase_fs_size_too_large(self):
        ...
        # VA 7.2 and VA 7.4
        expected_error_logs = ['fs ERROR V-493-10-2326 Unable to allocate '
                               'space to grow fs 6817-fs1_test06_b due to '
                               'either insufficient space|fs ERROR V-288-2128 '
                               'Unable to allocate space to grow fs '
                               '6817-fs1_test06_b due to either insufficient '
                               'space']
    ...
    @attr('all', 'revert', 'story6817', 'story6817_tc07')
