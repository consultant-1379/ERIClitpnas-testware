...
class Story12032(GenericTest):
    ...
    def setUp(self):
        ...
        self.sfs_to_be_deleted = []

    def tearDown(self):
        """Run after every test"""
        super(Story12032, self).tearDown()
        for sfs_export in self.sfs_to_be_deleted:
            self.clean_sfs(sfs_export['file_system'], sfs_export['path'])
        self.sfs_to_be_deleted = []
    ...
    @attr('all', 'revert', 'story12032', 'story12032_tc01')
    def test_01_p_update_nfs_mount_provider_to_vip(self):
        ...
        try:
            ...
            self.sfs_to_be_deleted.append({
                'file_system': file_system,
                'path': path
            })

    # attr('all', 'revert', 'story12032', 'story12032_tc02')
    def obsolete_02_n_update_nfs_mounts_provider_to_incorrect_values(self):
        """
        Converted to AT
    ...
    @attr('all', 'revert', 'story12032', 'story12032_tc03')
