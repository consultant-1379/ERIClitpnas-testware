...
class Story6815(GenericTest):
    ...
    @attr('pre-reg', 'revert', 'story6815', 'story6815_tc01')
    ...
    @attr('pre-reg', 'revert', 'story6815', 'story6815_tc03')
    ...
    @attr('pre-reg', 'revert', 'story6815', 'story6815_tc07')
    ...
    def obsolete_08_n_repeated_ipaddress(self):
        ...
        sfs_export_props2 = "ipv4allowed_clients=" + "'" + \
                            ...
                            self.node1_ip_address + "," + \
                            self.node2_ip_address + "' "
        error_message = 'Duplicate IP address detected "' + \
                        self.node1_ip_address + '"'
    ...
    @attr('pre-reg', 'revert', 'story6815', 'story6815_tc09')
    ...
    @attr('pre-reg', 'revert', 'story6815', 'story6815_tc10')
