...
class Story8062(GenericTest):
    ...
    @attr('pre-reg', 'revert', 'story8062', 'story8062_tc01')
    ...
    @attr('pre-reg', 'revert', 'story8062', 'story8062_tc02')
    ...
    @attr('pre-reg', 'revert', 'story8062', 'story8062_tc03')
    ...
    @attr('pre-reg', 'revert', 'story8062', 'story8062_tc05')
    ...
    @attr('pre-reg', 'revert', 'story8062', 'story8062_tc06')
    ...
    @attr('pre-reg', 'revert', 'story8062', 'story8062_tc07')
    ...
    @attr('pre-reg', 'revert', 'story8062', 'story8062_tc08')
    def test_08_n_export_that_exists_on_sfs_with_different_options(self):
        ...
        expected_error_logs = ['already exists in NAS but '
                               'it\'s options do not match']
        self.assertTrue(
            self.set_node_connection_data(
                self.nas_server, username=test_constants.SFS_MASTER_USR,
                password=test_constants.SFS_MASTER_PW))
    ...
    @attr('pre-reg', 'revert', 'story8062', 'story8062_tc09')
