...
class Story5284(GenericTest):
    ...
    def check_mount_in_fstab(self, item2grep, mnt_path, node, entries_count=1):
        """
        ...
        # Asserts that the number of mount entries are as expected
        self.assertTrue(len(out) == entries_count)
    ...
    def __get_non_sfs_path_name(self):
        ...
        if nfs_existing_path:
            ...
            sfs_service_url = self.find(self.ms_node, "/infrastructure",
                                       "storage-provider-base",
                                       rtn_type_children=False, find_refs=True)
            nfs_service = sfs_service_url[0] + '/sp1_5284'
            nfs_name = 'nfs1'
            ...
            self.load_xml(sfs_service_url[0], "xml_story5436.xml")
    ...
    def test_01_p_create_sfs_unmanaged_mounts_ms(self):
        ...
        """
        # Test will only pass if the unmanaged FS already exists on the NAS
        # server.
        test_number = "_test01"
        ...
        nfsmount_url = self.find(self.ms_node, "/infrastructure",
                                 "storage", True)
        sfs_service = sfs_service_url[0] + '/sp1_5284' + test_number
    ...
    @attr('all', 'revert', 'story5284', 'story5284_tc03')
    def test_03_p_create_sfs_unmanaged_mnts_nodes_in_diff_directories(self):
        ...
        file_system1_n1 = nodes_url[0] + '/file_systems/nm1_5284' + test_number
        file_system2_n1 = nodes_url[0] + '/file_systems/nm2_5284' + test_number
        file_system1_n2 = nodes_url[1] + '/file_systems/nm1_5284' + test_number
        file_system2_n2 = nodes_url[1] + '/file_systems/nm2_5284' + test_number
    ...
    @attr('all', 'revert', 'story5284', 'story5284_tc04', 'cdb_priority1')
    ...
    @attr('all', 'revert', 'story5284', 'story5284_tc06')
    def test_06_p_create_non_sfs_unmanaged_mounts_nodes_in_diff_dirs(self):
        ...
        @tms_description: Test the creation of SFS unmanaged mounts on
        each node in different directories.
        Covers litpcds_5284_tc05 & litpcds_5284_tc08
        @tms_test_steps:
            @step: create nfs-service under infrastructure
            @result: nfs-service is created
        ...
        file_system1_n1 = nodes_url[0] + '/file_systems/nm1_5284' + test_number
        file_system1_n2 = nodes_url[0] + '/file_systems/nm2_5284' + test_number
        file_system2_n1 = nodes_url[1] + '/file_systems/nm1_5284' + test_number
        file_system2_n2 = nodes_url[1] + '/file_systems/nm2_5284' + test_number
    ...
    @attr('all', 'revert', 'story5284', 'story5284_tc09')
    ...
    @attr('all', 'revert', 'story5284', 'story5284_tc10')
    ...
    @attr('all', 'revert', 'story5284', 'story5284_tc11')
    ...
    @attr('all', 'revert', 'story5284', 'story5284_tc12')
    ...
    @attr('all', 'revert', 'story5284', 'story5284_tc25')
    ...
    @attr('all', 'revert', 'story5284', 'story5284_tc26')
