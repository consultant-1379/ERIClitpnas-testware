...
class Story2480(GenericTest):
    ...
    @attr('all', 'revert', 'story2480', 'story2480_tc02')
    ...
    @attr('all', 'revert', 'story2480', 'story2480_tc03')
    def test_03_p_verify_sfs_cache(self):
        ...
        try:
            ...
            self.log('info', "12. Assert cache size increased by the "
                             "correct amount")
            self.check_sfs(file_systems, cache_name=cache_name,
                           cache_size="4096", snaps=snaps)

            self.log('info', "13. Update the filesystem snapshot size")
            ...
            self.log('info', "19. Assert cache size increased by the "
                             "correct amount")
            self.check_sfs(file_systems, cache_name=cache_name,
    ...
    @attr('all', 'revert', 'story2480', 'story2480_tc06')
    ...
    @attr('all', 'revert', 'story2480', 'story2480_tc07')
    def test_07_p_multiple_filesystems_in_different_states(self):
        ...
        try:
            ...
            self.log('info', "8. Run remove_snapshot")
            self.delete_snapshot(name=snap)
            self.check_sfs(file_systems, snaps=snaps, snap_present=False,
                           cache_name=cache_name, cache_present=False)
    ...
    @attr('all', 'revert', 'story2480', 'story2480_tc14')
    ...
    @attr('all', 'revert', 'story2480', 'story2480_tc17')
    ...
    @attr('all', 'revert', 'story2480', 'story2480_tc18')
    ...
    @attr('all', 'revert', 'story2480', 'story2480_tc19')
